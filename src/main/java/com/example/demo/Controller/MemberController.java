...
import com.example.demo.service.AddMemberRequest;
...
public class MemberController {
    ...
    public String member_logout(Model model, HttpServletRequest request2, HttpServletResponse response) {
        ...
        } catch (Exception e) { // IllegalArgumentException 대신 포괄적인 Exception 처리
            model.addAttribute("error", "로그아웃 처리 중 오류가 발생했습니다."); // 에러 메시지 전달
            // 오류가 발생해도 로그아웃 처리 후 로그인 페이지로 이동하는 것이 일반적일 수 있습니다.
